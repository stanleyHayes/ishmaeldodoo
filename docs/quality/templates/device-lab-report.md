...
| Device/model/RAM  | OS           | Browser/build                  | Viewport/orientation | Network measurements        | EN/FR routes | Desk result | Accessibility/zoom | Evidence     | Result  |
| ----------------- | ------------ | ------------------------------ | -------------------- | --------------------------- | ------------ | ----------- | ------------------ | ------------ | ------- |
