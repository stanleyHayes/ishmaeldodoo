...
- [x] Alert 25 remediated: generated HTML now rejects external/protocol-relative,
      file and script resources before private-file creation, is capped at 2 MiB,
      and Chromium receives a deny-all host resolver rule; hosted rescan pending.
