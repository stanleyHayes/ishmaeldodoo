# Training and rehearsal evidence

Create one dated copy of this record per session. Do not record passwords, tokens, confidential content or personal-data fixtures.
...
| Scenario                                                               | Required roles                       | Start/end | Result  | Evidence reference | Follow-up owner/date |
| ---------------------------------------------------------------------- | ------------------------------------ | --------- | ------- | ------------------ | -------------------- |
