...
Record the review in the controlled
[`source-claim-audit-record.md`](templates/source-claim-audit-record.md). Its
expected/reviewed totals must reconcile exactly to the protected export for
both locales and the Source Register; partial sampling or an aggregate
percentage cannot be approved.
