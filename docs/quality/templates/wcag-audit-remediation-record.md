# Independent WCAG 2.2 AA audit and remediation record
...
The final report must identify every tested route/workflow, success criterion,
browser, assistive technology, device and finding. Every critical/high finding
must be closed and independently retested before launch; lower-severity
exceptions require a named authority, rationale, owner and expiry. Automated
axe/Lighthouse results, internal review, browser emulation or a vendor invoice
do not constitute an independent conformance result. Do not store tester
personal data, credentials, Room content, request prose or unpublished content
in this repository.
