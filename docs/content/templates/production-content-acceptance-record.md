# Production content, identity and translation acceptance record
...
Every approved item must identify its immutable CMS version and locale. Counts
must reconcile to the frozen export; a route rendering successfully does not
approve its claims, translation, identity, media or rights. Content changes
after freeze require a recorded exception, fresh source/media checks, a new
export digest and reapproval. Do not place unpublished payloads, confidential
source notes, personal data, credentials or restricted rights evidence in this
repository.
