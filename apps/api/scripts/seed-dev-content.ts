...
async function seedDevContent(): Promise<void> {
  ...
  try {
    ...
    await database.collection("media_assets").insertMany([
      ...
      // Placeholder Record field images (Acts one–four). Locally generated,
      // on-brand thematic art served from apps/web/public/seed so the layout
      // renders with real images; replace with approved field photography.
      ...[
        [
          "201",
          "record-act-1-forest.png",
          "one",
          "un",
          "the Western Region forest",
          "la forêt de la Région de l’Ouest",
        ],
        [
          "202",
          "record-act-2-institutions.png",
          "two",
          "deux",
          "post-conflict institutions",
          "les institutions post-conflit",
        ],
        [
          "203",
          "record-act-3-sahel.png",
          "three",
          "trois",
          "the Sahel borderlands",
          "les zones frontalières du Sahel",
        ],
        [
          "204",
          "record-act-4-accra.png",
          "four",
          "quatre",
          "Accra and the night economy",
          "Accra et l’économie nocturne",
        ],
        ...
        version: 1,
        altText: localized(
          `Placeholder field imagery evoking ${themeEn} (Act ${actEn})`,
          `Image d'illustration évoquant ${themeFr} (Acte ${actFr})`,
        ),
        credit: "Placeholder (generated)",
        licence: "Editorial use",
        transformationPolicy: "editorial",
        retentionPolicy: "standard",
        legalHold: false,
